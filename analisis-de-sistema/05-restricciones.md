...
| **RC06** | Tecnología del backend | El backend debe desarrollarse utilizando Node.js. |
| **RC07** | Base de datos | La información del sistema debe almacenarse en PostgreSQL. |